# Arc-Length - dominant dof implementation
# =====================================
...
function step!(alg::ArcLength, Uₖ, ModelSol, KTₖ, Fintk, time, U, dispIter, varFext, currδu, convδu, λₖ, c)
    ...
    else # Jirasek method - dominant dofs
        c = view(c, freeDofs)
