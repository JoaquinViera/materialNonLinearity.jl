...
sfig22 = plot(σArr[2][tf-1][1], p * h / 2, markershape=:circle, lw=lw, ms=ms, title="stress", label=@sprintf("M = %0.2f", mVec[tf-1]), minorgrid=1, draw_arrow=1, legend=:topright)
plot!(sfig22, σArr[2][tf-1][10], p * h / 2, markershape=:circle, lw=lw, ms=ms, title="stress", label=@sprintf("M = %0.2f", mVec[tf-1]), minorgrid=1, draw_arrow=1)
plot!(sfig22, σArr[2][tf-1][end], p * h / 2, markershape=:circle, lw=lw, ms=ms, title="stress", label=@sprintf("M = %0.2f", mVec[tf-1]), minorgrid=1, draw_arrow=1)
# plot!(sfig2, σArr[3][end][1], p * h / 2, markershape=:circle, lw=lw, ms=ms, title="stress", label=@sprintf("M = %0.2f", mVec[end]), minorgrid=1, draw_arrow=1)
# plot!(sfig2, σArr[3][end][10], p * h / 2, markershape=:circle, lw=lw, ms=ms, title="stress", label=@sprintf("M = %0.2f", mVec[end]), minorgrid=1, draw_arrow=1)
# plot!(sfig2, σArr[3][end][end], p * h / 2, markershape=:circle, lw=lw, ms=ms, title="stress", label=@sprintf("M = %0.2f", mVec[end]), minorgrid=1, draw_arrow=1)
...
sfigElem1 = plot(σArr[1][tf][1], p * h / 2, markershape=:circle, lw=lw, ms=ms, title="stress", label=@sprintf("M = %0.2f", mVec[tf]), minorgrid=1, draw_arrow=1, legend=:topright)
plot!(sfigElem1, σArr[1][tf-1][1], p * h / 2, markershape=:circle, lw=lw, ms=ms, title="stress", label=@sprintf("M = %0.2f", mVec[tf-1]), minorgrid=1, draw_arrow=1)
plot!(sfigElem1, σArr[1][tf-2][1], p * h / 2, markershape=:circle, lw=lw, ms=ms, title="stress", label=@sprintf("M = %0.2f", mVec[tf-2]), minorgrid=1, draw_arrow=1)
plot!(sfigElem1, σArr[1][tf-3][1], p * h / 2, markershape=:circle, lw=lw, ms=ms, title="stress", label=@sprintf("M = %0.2f", mVec[tf-3]), minorgrid=1, draw_arrow=1)
plot!(sfigElem1, σArr[1][tf-4][1], p * h / 2, markershape=:circle, lw=lw, ms=ms, title="stress", label=@sprintf("M = %0.2f", mVec[tf-4]), minorgrid=1, draw_arrow=1)
plot!(sfigElem1, σArr[1][tf-5][1], p * h / 2, markershape=:circle, lw=lw, ms=ms, title="stress", label=@sprintf("M = %0.2f", mVec[tf-5]), minorgrid=1, draw_arrow=1)
plot!(sfigElem1, σArr[1][tf-6][1], p * h / 2, markershape=:circle, lw=lw, ms=ms, title="stress", label=@sprintf("M = %0.2f", mVec[tf-6]), minorgrid=1, draw_arrow=1)
plot!(sfigElem1, σArr[1][tf-7][1], p * h / 2, markershape=:circle, lw=lw, ms=ms, title="stress", label=@sprintf("M = %0.2f", mVec[tf-7]), minorgrid=1, draw_arrow=1)
plot!(sfigElem1, σArr[1][tf-8][1], p * h / 2, markershape=:circle, lw=lw, ms=ms, title="stress", label=@sprintf("M = %0.2f", mVec[tf-8]), minorgrid=1, draw_arrow=1)
plot!(sfigElem1, zeros(length(p)), p * h / 2, lw=lw, ms=ms, label="", color=:"black")

sfigElem2 = plot(σArr[2][tf][1], p * h / 2, markershape=:circle, lw=lw, ms=ms, title="stress", minorgrid=1, draw_arrow=1, legend=:false)
plot!(sfigElem2, σArr[2][tf-1][1], p * h / 2, markershape=:circle, lw=lw, ms=ms, title="stress", minorgrid=1, draw_arrow=1)
plot!(sfigElem2, σArr[2][tf-2][1], p * h / 2, markershape=:circle, lw=lw, ms=ms, title="stress", minorgrid=1, draw_arrow=1)
plot!(sfigElem2, σArr[2][tf-3][1], p * h / 2, markershape=:circle, lw=lw, ms=ms, title="stress", minorgrid=1, draw_arrow=1)
plot!(sfigElem2, σArr[2][tf-4][1], p * h / 2, markershape=:circle, lw=lw, ms=ms, title="stress", minorgrid=1, draw_arrow=1)
plot!(sfigElem2, σArr[2][tf-5][1], p * h / 2, markershape=:circle, lw=lw, ms=ms, title="stress", minorgrid=1, draw_arrow=1)
plot!(sfigElem2, σArr[2][tf-6][1], p * h / 2, markershape=:circle, lw=lw, ms=ms, title="stress", minorgrid=1, draw_arrow=1)
plot!(sfigElem2, σArr[2][tf-7][1], p * h / 2, markershape=:circle, lw=lw, ms=ms, title="stress", minorgrid=1, draw_arrow=1)
plot!(sfigElem2, σArr[2][tf-8][1], p * h / 2, markershape=:circle, lw=lw, ms=ms, title="stress", minorgrid=1, draw_arrow=1)
plot!(sfigElem2, zeros(length(p)), p * h / 2, lw=lw, ms=ms, label="", color=:"black")

sfigElem3 = plot(σArr[3][tf][1], p * h / 2, markershape=:circle, lw=lw, ms=ms, title="stress", minorgrid=1, draw_arrow=1, legend=:false)
plot!(sfigElem3, σArr[3][tf-1][1], p * h / 2, markershape=:circle, lw=lw, ms=ms, title="stress", minorgrid=1, draw_arrow=1)
plot!(sfigElem3, σArr[3][tf-2][1], p * h / 2, markershape=:circle, lw=lw, ms=ms, title="stress", minorgrid=1, draw_arrow=1)
plot!(sfigElem3, σArr[3][tf-3][1], p * h / 2, markershape=:circle, lw=lw, ms=ms, title="stress", minorgrid=1, draw_arrow=1)
plot!(sfigElem3, σArr[3][tf-4][1], p * h / 2, markershape=:circle, lw=lw, ms=ms, title="stress", minorgrid=1, draw_arrow=1)
plot!(sfigElem3, σArr[3][tf-5][1], p * h / 2, markershape=:circle, lw=lw, ms=ms, title="stress", minorgrid=1, draw_arrow=1)
plot!(sfigElem3, σArr[3][tf-6][1], p * h / 2, markershape=:circle, lw=lw, ms=ms, title="stress", minorgrid=1, draw_arrow=1)
plot!(sfigElem3, σArr[3][tf-7][1], p * h / 2, markershape=:circle, lw=lw, ms=ms, title="stress", minorgrid=1, draw_arrow=1)
plot!(sfigElem3, σArr[3][tf-8][1], p * h / 2, markershape=:circle, lw=lw, ms=ms, title="stress", minorgrid=1, draw_arrow=1)
plot!(sfigElem3, zeros(length(p)), p * h / 2, lw=lw, ms=ms, label="", color=:"black")

# sfigElem4 = plot(σArr[4][tf-1][1], p * h / 2, markershape=:circle, lw=lw, ms=ms, title="stress", minorgrid=1, draw_arrow=1, legend=:false)
# plot!(sfigElem4, σArr[4][tf-2][1], p * h / 2, markershape=:circle, lw=lw, ms=ms, title="stress", minorgrid=1, draw_arrow=1)
# plot!(sfigElem4, σArr[4][tf-3][1], p * h / 2, markershape=:circle, lw=lw, ms=ms, title="stress", minorgrid=1, draw_arrow=1)
# plot!(sfigElem4, σArr[4][tf-4][1], p * h / 2, markershape=:circle, lw=lw, ms=ms, title="stress", minorgrid=1, draw_arrow=1)
# plot!(sfigElem4, σArr[4][tf-5][1], p * h / 2, markershape=:circle, lw=lw, ms=ms, title="stress", minorgrid=1, draw_arrow=1)
# plot!(sfigElem4, σArr[4][tf-6][1], p * h / 2, markershape=:circle, lw=lw, ms=ms, title="stress", minorgrid=1, draw_arrow=1)
# plot!(sfigElem4, σArr[4][tf-7][1], p * h / 2, markershape=:circle, lw=lw, ms=ms, title="stress", minorgrid=1, draw_arrow=1)
# plot!(sfigElem4, σArr[4][tf-8][1], p * h / 2, markershape=:circle, lw=lw, ms=ms, title="stress", minorgrid=1, draw_arrow=1)
# plot!(sfigElem4, σArr[4][tf-9][1], p * h / 2, markershape=:circle, lw=lw, ms=ms, title="stress", minorgrid=1, draw_arrow=1)
# plot!(sfigElem4, zeros(length(p)), p * h / 2, lw=lw, ms=ms, label="", color=:"black")

plot(sfigElem2, sfigElem3)
